...
import com.begood.smarthome.server.DeviceDataResult;
import com.begood.smarthome.server.DeviceDataSet;
import com.begood.smarthome.server.ServerReturnResult;
import com.begood.smarthome.server.setServerURL;
import com.begood.smarthome.service.Cfg;
import com.begood.smarthome.service.ConfigService;
import com.begood.smarthome.tools.shareToWiexin;
import com.begood.smarthome.view.CircleAndNumberView;
import com.begood.smarthome.R;
import com.begood.smarthome.view.MyDialogView;
 ...
 *:2016-03-24
 **********************************************************/
public class BGPM08RealtimeDataActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{

    final String TAG = "BGPM08";
    ...
    static final int GET_CURRENT_SUCCEED    = 3;
    static final int GET_CURRENT_FAIL      = 4;
    static final int UPDATE_FAIL           = 6;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case GET_CURRENT_SUCCEED:
                    ...
                    else
                    {
                        ...
                        dataTitle.setTextColor(ContextCompat.getColor
                                (BGPM08RealtimeDataActivity.this, R.color.sbc_snippet_text));
                ...
                case GET_CURRENT_FAIL:
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "设备错误", Toast.LENGTH_SHORT)
                        .show();

                    intent.setClass(BGPM08RealtimeDataActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                    break;
                case CHOSE_DEVICE_NULL:
                    dbService = new ConfigDao(BGPM08RealtimeDataActivity.this.getBaseContext());
                    Cfg.currentDeviceID = "";
                    dbService.SaveSysCfgByKey(Cfg.KEY_DEVICE_ID, Cfg.currentDeviceID);

                    Toast.makeText(BGPM08RealtimeDataActivity.this, "设备错误,请重新选择", Toast.LENGTH_SHORT)
                            .show();
                    intent.setClass(BGPM08RealtimeDataActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                ...
                case UPDATE_DATA:
                    ...
                    break;
                case UPDATE_FAIL:
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "网络不稳定", Toast.LENGTH_SHORT)
                            .show();
                    break;
                case CHANGE_PASSWORD_ERROR:
                    dialogView.closeMyDialog();
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "密码更新失败", Toast.LENGTH_SHORT)
                            .show();
                    break;
                case INPUT_PASSWORD_ERROR:
                    dialogView.closeMyDialog();
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "原密码输入错误", Toast.LENGTH_SHORT)
                            .show();
                    break;
                case CHANGE_PASSWORD_SUCCEED:
                    dialogView.closeMyDialog();
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "密码更新成功", Toast.LENGTH_SHORT)
                            .show();
                ...
                case SERVER_CANT_CONNECT:
                    AlertDialog.Builder failAlert = new AlertDialog.Builder(BGPM08RealtimeDataActivity.this);
                    ...
                    break;
                default:
                    Toast.makeText(BGPM08RealtimeDataActivity.this, "错误", Toast.LENGTH_SHORT)
                            .show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bgpm08_realtime_data);
...
//                }
        ...
        failAlert.setTitle("注销").setMessage("是否注销登录")
                .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Intent intent = new Intent();
                        intent.setClass(BGPM08RealtimeDataActivity.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                    }
    ...
    private class shareToWeixin implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            popup = new PopupMenu(BGPM08RealtimeDataActivity.this, v);
            ...
            popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener()
                    {
                        ...
                        {
                            Toast.makeText(BGPM08RealtimeDataActivity.this, "分享朋友圈中,请等待", Toast.LENGTH_SHORT).show();
                            switch (item.getItemId())
                            {
                                case R.id.friends:
                                    if(shareToWiexin.shareToFriend(BGPM08RealtimeDataActivity.this)
                                            != shareSucceed){
                                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(BGPM08RealtimeDataActivity.this);
                                    ...
                                    break;
                                case R.id.timeline:
                                    if(shareToWiexin.shareToWeiXinTimeline(BGPM08RealtimeDataActivity.this)
                                            != shareSucceed){
                                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(BGPM08RealtimeDataActivity.this);
                                        alertDialog.setTitle("错误").setIcon(R.drawable.error_01).setMessage("请确定微信可以启动")
                                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        {
            case 1:
                intent.setClass(BGPM08RealtimeDataActivity.this,DeviceHistoryDataActivitiy.class);
                startActivity(intent);
                break;
            case 2:
                intent.setClass(BGPM08RealtimeDataActivity.this,MainActivity.class);
            ...
            case 3:
                ...
                break;
            case 4:
                intent.setClass(BGPM08RealtimeDataActivity.this,HelpActivity.class);
                startActivity(intent);
                break;
            case 5:
                resign();
    ...
    private void showChangePasswordDialog(){
        LayoutInflater inflater = LayoutInflater.from(BGPM08RealtimeDataActivity.this);
        final View changePwdlayout = inflater.inflate(R.layout.change_password, null);

        AlertDialog.Builder myDialog = new AlertDialog.Builder(BGPM08RealtimeDataActivity.this)
                .setTitle("修改密码");
        ...
        myDialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                dialogView = new MyDialogView(BGPM08RealtimeDataActivity.this);
